<template>
  <div class="relative w-full h-full rounded-xl overflow-hidden bg-gradient-to-b from-sky-50 to-slate-100 dark:from-slate-800 dark:to-slate-900">
    ...
    <!-- Microscope controls -->
    <div v-if="isPlaced('microscope1')" class="absolute left-2 bottom-2 right-2 sm:left-3 sm:bottom-3 sm:right-auto sm:w-64 bg-white/95 dark:bg-gray-800/95 backdrop-blur rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-3 space-y-2.5">
