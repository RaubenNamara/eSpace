  ...
  <div>
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-600 shadow-lg shadow-indigo-500/20 p-4 sm:p-5 mb-6">
      ...
      <div class="relative flex items-center gap-3 mb-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-xs sm:text-sm text-indigo-100">Moderate assessment resources uploaded by teachers in your department</p>
        </div>
      </div>
    ...
    <div class="flex flex-wrap gap-2 mb-6">
      <button
        ...
        :key="opt.value"
        @click="statusFilter = opt.value; fetchResources()"
