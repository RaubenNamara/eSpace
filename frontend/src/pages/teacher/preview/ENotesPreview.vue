  ...
  <div>
    ...
    <template v-else-if="!activeSubjectId">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        ...
        >
          <div class="w-14 h-14 rounded-2xl flex items-center justify-center text-white font-bold text-base shadow-sm bg-amber-600 mb-4">
    ...
    <template v-else>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div class="w-10 h-10 rounded-lg bg-amber-600 flex items-center justify-center mb-3">
