<?php
/**
 * Add login credentials to teachers table
 */
...
try {
    ...
    // Add username, email, password, role fields to teachers table
    $sql = "ALTER TABLE teachers 
            ...
            ADD COLUMN role ENUM('teacher') NOT NULL DEFAULT 'teacher' AFTER password,
    ...
    $pdo->exec($sql);
    echo "Successfully added login credentials to teachers table.\n";
